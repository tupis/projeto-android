...
Desafio feito através do [Curso em Vídeo](https://www.cursoemvideo.com/)
...
```
$ git clone https://github.com/tupis/projeto-android.git
```
2. Acesse a pasta do projeto no terminal/cmd
```
$ cd univer-landing-page
```
3. Inicie o arquivo html
```
$ start index.html
```
4. Abra seu editor de código
```
$ code .
``` 
